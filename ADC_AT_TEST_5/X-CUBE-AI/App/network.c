...
#define AI_NETWORK_MODEL_SIGNATURE     "8c176a9c3d868d590c1a5c64c0099f43"
...
#define AI_TOOLS_DATE_TIME   "Mon Nov 20 16:55:24 2023"
...
/* Array#1 */
AI_ARRAY_OBJ_DECLARE(
  serving_default_reshape_4_input0_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0, 0x0,
  AI_SHAPE_INIT(4, 2, 3, 3, 2), AI_STRIDE_INIT(4, 4, 8, 24, 72),
  1, &conv2d_9_weights_array, NULL)

/* Tensor #1 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_reshape_4_input0_output, AI_STATIC,
  1, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 1, 10240), AI_STRIDE_INIT(4, 4, 4, 4, 4),
  1, &serving_default_reshape_4_input0_output_array, NULL)

/* Tensor #2 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_reshape_4_input0_output0, AI_STATIC,
  2, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 256, 40), AI_STRIDE_INIT(4, 4, 4, 4, 1024),
  1, &serving_default_reshape_4_input0_output_array, NULL)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 1, 2, 7, 7), AI_STRIDE_INIT(4, 4, 4, 8, 56),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  12, 0x0,
  AI_SHAPE_INIT(4, 1, 2, 14, 2), AI_STRIDE_INIT(4, 4, 4, 8, 112),
...
AI_STATIC_CONST ai_float upsample_4_scales_data[] = { 0.4, 0.0625, 1.0, 1 };
AI_ARRAY_OBJ_DECLARE(
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_reshape_4_input0_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &upsample_4_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 844, 1, 1),
    844, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 41984, 1, 1),
    41984, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_reshape_4_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &nl_12_output),
  &upsample_4_layer, 0, NULL)
