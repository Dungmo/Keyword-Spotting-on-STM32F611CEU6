...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "spch_cmd24"
...
#define AI_NETWORK_IN_1_HEIGHT      (10240)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (10240 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  (40960)
